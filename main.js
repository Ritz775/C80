...
function submit() {
  ...
  var length_of_the_name_student_array = name_of_the_student_array.length;
  console.log(length_of_the_name_student_array);
  for (var k = 0; k < length_of_the_name_student_array; k++) {
